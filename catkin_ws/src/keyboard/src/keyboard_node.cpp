...
#define KEYCODE_UP 0x69 // I, Z axis up
#define KEYCODE_LEFT 0x6A // J, Z rotate clockwise
#define KEYCODE_RIGHT 0x6C // L, Z rotate anticlockwise
#define KEYCODE_DOWN 0x6B // K, Z axis down
